...
def render_dashboard_html(
    *,
    ...
    return (
        ...
        "</div>"
        '<div class="card dash-playback-card" id="dash-playback-bar" role="group" aria-label="3D playback">'
        '<h2 class="card-title">Playback</h2>'
        '  <div class="dp-head">'
        '    <button type="button" class="dp-btn" id="dash-playback-play" disabled>Play</button>'
        '    <button type="button" class="dp-btn secondary" id="dash-playback-all" disabled>All</button>'
