...
def render_dashboard_html(
    *,
    ...
    return (
        ...
        "</div>"
        '<div class="card">'
        '<h2 class="card-title">Distillation</h2>'
        '<div class="gt-card-body" style="padding:8px 0;font-size:12px;">'
        '<div style="color:var(--sub);margin-bottom:8px;">'
        'Fit HSV / shape_gate / selector params from SAM 3 GT records. '
        'Label sessions on the <a href="/gt" '
        'style="color:var(--accent);text-decoration:none;">GT page →</a> '
        'before running the fit.'
        '</div>'
        '<form method="POST" action="/gt/distill" style="margin:0;">'
        '<button type="submit" class="ev-btn accent" '
        'title="Fit against all GT records and write data/gt/fit_proposals.json">'
