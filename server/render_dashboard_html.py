...
def render_dashboard_html(
    *,
    ...
    return (
        ...
        '<input type="search" class="events-search" id="events-search" '
        'placeholder="Search hash…" autocomplete="off" spellcheck="false" '
        'title="Filter by session hash (substring match on s_xxxxxxxx)">'
        ...
        '<div class="dash-playback-card" id="dash-playback-bar" role="group" aria-label="3D playback">'
        '  <div class="dp-head">'
        '    <span class="dp-label">Playback</span>'
        '    <button type="button" class="dp-btn" id="dash-playback-play" disabled>Play</button>'
        '    <button type="button" class="dp-btn secondary" id="dash-playback-all" disabled>Show all</button>'
        '    <span class="dp-time" id="dash-playback-time">—</span>'
        '  </div>'
        '  <input type="range" id="dash-playback-scrub" min="0" max="0" step="0.001" value="0" disabled aria-label="3D playback time">'
        '  <div class="dp-rate-group" role="group" aria-label="Playback speed">'
        '    <button type="button" class="dp-rate" data-dash-playback-rate="0.25">0.25×</button>'
        '    <button type="button" class="dp-rate" data-dash-playback-rate="0.5">0.5×</button>'
        '    <button type="button" class="dp-rate active" data-dash-playback-rate="1">1×</button>'
        '  </div>'
        '</div>'
        ...
        '      <button type="button" class="ff-path active" data-fit-path="live">'
        '<span class="ff-path-label">LIVE</span>'
        '<span class="ff-path-count" data-fit-path-count="live"></span>'
        '</button>'
        '      <button type="button" class="ff-path" data-fit-path="server_post">'
        '<span class="ff-path-label">SVR</span>'
        '<span class="ff-path-count" data-fit-path-count="server_post"></span>'
        '</button>'
        '    </div>'
        '  </span>'
