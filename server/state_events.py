        ...
        events.append(
            {
                ...
                # Per-path frozen detection-config snapshots mirrored
                # onto SessionResult. Renderer uses the embedded HSV +
                # shape-gate values directly, so custom configs and
                # deleted presets still render an honest CFG strip.
                "live_config_used": (
